...
namespace UnityStandardAssets._2D
{
    public class CameraFollow : MonoBehaviour
    {
        ...
        public Transform m_Player { get; set; } // Reference to the player's transform.
        ...
        private void TrackPlayer()
        {
            ...
            if (CheckXMargin())
            {
                ...
                targetX = Mathf.Lerp(transform.position.x, m_Player.position.x + 2 * m_Player.localScale.x, xSmooth*Time.deltaTime);
            }
